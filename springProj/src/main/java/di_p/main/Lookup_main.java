...
public class Lookup_main {
	...
	public static void main(String[] args) {
		...
		cs.order_void();
		//System.out.println("order_void : " + cs.order_void()); void는 리턴 불가
		
		//리턴형이 다른 메소드는 look-method 불가
		...
		//추상메소드를 lookup-method로 재정의하여 실행
		System.out.println("order_hunter : " + cs.order_hunter());
		
		
		//추상메소드를 재정의하지 않고 실행시 에러발생
		System.out.println("order_hunter : " + cs.order_ratte());
		
		/*
		
		식단표 의 식단을 xml 에서 지정하세요
